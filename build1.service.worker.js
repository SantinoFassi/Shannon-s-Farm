...
/** @type {string} */
const CACHE_VERSION = '1741798258|3081197680';
/** @type {string} */
const CACHE_PREFIX = 'Shannon's farm-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'build1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["build1.html","build1.js","build1.offline.html","build1.icon.png","build1.apple-touch-icon.png","build1.audio.worklet.js","build1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["build1.wasm","build1.pck"];
